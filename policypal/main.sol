...
contract Deployer{
     ...
     //address a = 0xABC;
     //address b = 0xABC;
     //uint c = 1000000000 * 10 ** 18;
     //uint d = c / 2;
     //uint e = 373989000 * 10 ** 18;
     //uint f = 1519633800;
     //uint g = 1519806600;
     //uint h = 1519720200;
     //uint j = 21000;
    //uint minContribution = 0.1 * 10 ** 18;
    //uint maxContribution = 1 * 10 ** 18;
    ...
    PolicyPalNetworkCrowdsale p = new PolicyPalNetworkCrowdsale(0xabc1111111111111111111111111111111111111,
                                                                ...
                                                                100000000000000000,
                                                                1000000000000000000);
    //PolicyPalNetworkToken t = new PolicyPalNetworkToken(1000000000000000000000000000, 0xabc2222222222222222222222222222222222222);
    //PolicyPalNetworkCrowdsale p = new PolicyPalNetworkCrowdsale(msg.sender,b,c,d,e,f,g,h,j,minContribution,maxContribution);
}
