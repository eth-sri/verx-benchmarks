...
contract Deployer{
    //ZebiCoinCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, address _wallet,uint256 _minTransAmount,uint256 _mintedTokensCap);
    ZebiCoinCrowdsale z = new ZebiCoinCrowdsale(now, now+4 weeks, 1, 0x123, 1000, 1000 * 10**8);
}
